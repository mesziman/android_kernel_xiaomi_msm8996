...
HOSTCC       = $(CCACHE) gcc
HOSTCXX      = $(CCACHE) g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -Ofast -pipe -fomit-frame-pointer -std=gnu89 -march=armv8-a -mfpu=crypto-neon-fp-armv8 -mcpu=cortex-a57
...
CFLAGS_MODULE   = -march=armv8-a -mfpu=crypto-neon-fp-armv8 -mcpu=cortex-a57
AFLAGS_MODULE   =
LDFLAGS_MODULE  = --strip-debug
CFLAGS_KERNEL	= -march=armv8-a -mfpu=crypto-neon-fp-armv8 -mcpu=cortex-a57
AFLAGS_KERNEL	=
